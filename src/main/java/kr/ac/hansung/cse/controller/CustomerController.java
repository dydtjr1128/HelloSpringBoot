...
public class CustomerController {
	...
	@GetMapping(value="/customers", produces=MediaType.APPLICATION_JSON_VALUE)//여기서 생성되는 바디가 JSON 형태이다라고 알려줌
	...
	public ResponseEntity<Void> postCustomer(@RequestBody Customer customer) {
		...
		repository.save(new Customer(firstName, lastName));//id는 저장하지 않지만 자동으로 할당된다.
